    ...
    <div class="flex items-center justify-center mt-14 bg-gray-100 shadow-md sm:rounded-lg w-full">
        <div class="relative overflow-auto m-4">
            ...
            <div class="p-4 rounded-lg dark:border-gray-700 mt-14 w-full">
                ...
                <h3 class="text-2xl font-bold text-center">Add New Category </h3>
                    ...
                    <div class="mt-0">
                        ...
                        <div class="mt-0">
                            <label class="block" for="Name">Name<label>
                                    <input type="email" placeholder="eg. cloth, food" name="loginEmail"
                        ...
                        text-blue-100 
                        border duration-200 ease-in-out 
                        border-[#0c1c96] transition" type="submit" name="login">Save
                        </button>
                    </div>
                </form>
            </div>
